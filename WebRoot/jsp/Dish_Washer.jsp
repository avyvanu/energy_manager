...
<br>
	...
	<div class="hdr-area">Dish Washer</div><br>

	<!-- progbar.asp removed -->

<form name="frm3" action="Dish_Washer.jsp" method="post">
<div class="calcframe">
  <div align="center">
    <table border="0" cellpadding="0" cellspacing="0">
      <tbody><tr><td rowspan="10" width="10">&nbsp;</td><td colspan="2" height="5">&nbsp;</td></tr>
       ...
       <tr><td>Assumed Wattage</td><td><input name="txtG1Wattage" type="text" id="txtG1Wattage" value="39"/></td></tr>
        <tr>
          <td>Loads Per Week </td>
          <td>
            <input name="txtG3Loads" value="1" type="text"/></td>
       </tr>
        <tr>
          <td>&nbsp;</td>
       </tr>
          ...
          <tr><td>&nbsp;</td><td><input name="G1Compute" value="Compute" type="submit" style="font-size: 14px;"/><br>
            <input name="check" value="diswasher" type="hidden"/> 
            <input name="hid1" type="hidden"/>            </td>
       </tr>
       
        
      <%
      String hj=request.getParameter("txtG1Wattage");
     
      String hj1=request.getParameter("txtG3Loads");
      String hj2=request.getParameter("txtG1Hours");
        ...
        if(hj!=null & hj1!=null)
        {
       	 	u=Integer.parseInt(hj);
       	 	j=Integer.parseInt(hj1);
        }
       ...
       %>
        ...
        <tr>
          <td>kWh per Year </td>
          <td><input name="txtG3kWh" type="text" value="<%=h%>"/> </td>
       </tr>
        <tr>
          <td>Rs. per Year </td>
          <td>
            <input name="txtG3Dollars" type="text" value="<%=rs %>"/>            </td>
       </tr>
