...
function getChoices(form)
{
  ...
  values  = new Array();
  options = form.sel1G7Light.options;
...
<br>
	...
	<div class="hdr-area">Lighting</div><br>

	<!-- progbar.asp removed -->

<!-- Group 7 -->

<form name="frm7" action="LightingCalculator.jsp" method="post">
<div class="calcframe">
  <div align="center">
    <table border="0" cellpadding="0" cellspacing="0">
      <tbody><tr>
        ...
        <tr>
          <td>Bulb Type</td>
        <td>
          <select name="sel1G7Light" onchange="getChoices(this.form)">
            <option value="20">Compact fluorescent </option>
            <option value="75">Incandescent</option>
            <option value="46">Fluorescent standard ballast</option>
            <option value="42">Fluorescent high efficiency ballast</option>
            <option value="36">Fluorescent electronic ballast</option>
            <option value="300">Halogen, (torchiere)</option>
            <option value="50">Halogen, (low voltage)</option>
            </select>
          </td>
      </tr>
        <tr><td>Bulb Wattage </td><td><input name="txtG1Wattage" value="20" type="text" id="txtG1Wattage"/></td></tr>
        <tr><td>Quantity </td><td><input name="txtG7Qty" value="1" type="text"/><br></td></tr>
        <tr><td>Average hours per week </td><td><input name="txtG7Hours" value="1" type="text"/><br></td></tr>
        <tr><td>&nbsp;</td></tr>
        <tr><td>&nbsp;</td><td><input name="G7Compute" value="Compute" type="submit" style="font-size: 14px;"/><br>
          <input name="check" value="lighting" type="hidden"/>
          <input name="hid1" type="hidden"/></td></tr>
           ...
           <%
      		...
      		String tquntty=request.getParameter("txtG7Qty");
      		String nohourperweek=request.getParameter("txtG7Hours");
       ...
       %>
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td>kWh per Year </td><td><input name="txtG7kWh" type="text" value="<%=h %>"/></td></tr>
        <tr><td>Dollars per Year </td><td><input name="txtG7Dollars" type="text" value="<%=rs %>"/><br><br></td></tr>
        </tbody>
    </table>
  </div>
</div>
