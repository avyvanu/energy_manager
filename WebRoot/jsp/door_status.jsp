...
<%   
  ...
  //response.sendRedirect("registration.jsp");
    ...
    String qu1="SELECT  SUM(product_count),count(*),CURRENT_TIME() FROM energy_data where rf_node_id='2'  and DATE_FORMAT(date_time, '%Y-%m-%d') = '2011-05-11' ORDER BY id DESC LIMIT 1";
 	String temp="SELECT raw_mat  FROM energy_data where rf_node_id='4'  and date(date_time) = '2011-05-11' ORDER BY id DESC";
    String No_Door_open="SELECT  power_status  FROM energy_data where rf_node_id='8'  and DATE_FORMAT(date_time, '%Y-%m-%d') ='2011-05-11'";
   ...
   // System.out.println("ddd"+temp);
    ...
    //int totalDoorOpen
     ...
     if(d_1.next())
       ...
       while(rs_temp.next())
      {
      		store_tempetaure=rs_temp.getString(1);
     }
    int totalFinal=0;
    int totalDoorOpen=0; 
...
<tbody><tr>
  ...
  <!-- <td id="" classname="white" class="white">
   ...
   <td classname="white" class="white" id="" style="text-align: left">
   Tata Global Beverage(No Freezer)
  Stabilizer Info: Rated - 0.85 KVA
   ...
   <td classname="white" class="white" id="" style="text-align: center;"><%=location%>
    ...
    <td classname="white" class="white" id="" style="text-align: center;"><%=count%>
 </td>
   </tr>
