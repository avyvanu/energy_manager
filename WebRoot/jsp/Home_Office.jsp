...
function getChoices(form)
{
  ...
  values  = new Array();
  options = form.sel1G1App.options;
...
<br>
	...
	<div class="hdr-area">Home Office</div><br>

	<!-- progbar.asp removed -->

<form name="frm14" action="Home_Office.jsp" method="post">
<div class="calcframe">
  <div align="center">
  <table border="0" cellpadding="0" cellspacing="0">
    <tbody><tr>
      ...
      <tr>
        <td>Equipment</td>
        <td>
          <select name="sel1G1App" onchange="getChoices(this.form)">
            <option value="270">Computer (CPU &amp; Monitor)</option>
			<option value="40">Printer - Ink Jet (sm)</option>
            <option value="50">Printer - Ink Jet (med)</option>
            <option value="340">Printer - Laser (sm) </option>
            <option value="530">Printer - Laser (med)</option>
            <option value="38">Multi-Function - Print/Scan/Copy/Fax (sm)</option>
            <option value="50">Multi-Function - Print/Scan/Copy/Fax (med)</option>
          </select>          
		</td>
      </tr>
      <tr><td>Assumed Wattage</td><td><input name="txtG1Wattage" type="text" id="txtG1Wattage" value="270"/><font size="-3">(In Use)</font></td></tr>
      <tr><td>&nbsp;</td><td><input name="txtG14Wattage2" value="30" size="5" type="text"/><font size="-3">(Sleep Mode)</font></td></tr>
      <tr><td>Quantity </td><td><input name="txtG14Qty" value="1" size="2" type="text"/><br></td></tr>
      <tr><td>Average hours per week </td><td><input name="txtG14Hours" value="40" size="5" type="text"/><font size="-3">(In Use)</font><br></td></tr>
      <tr><td>&nbsp;</td><td><input name="txtG14Hours2" value="123" size="5" type="text"/><font size="-3">(Sleep Mode)</font><br></td></tr>
      <tr><td>&nbsp;</td></tr>
      <tr><td>&nbsp;</td><td><input name="G14Compute" value="Compute" type="submit" style="font-size: 14px;"/><br>
        <input name="check" value="homoff" type="hidden"/>
   ...
   <%
      String assume=request.getParameter("txtG1Wattage");
      String sleepmode=request.getParameter("txtG14Wattage2");
    
      String tquntty=request.getParameter("txtG14Qty");
     
      String nohourperweek=request.getParameter("txtG14Hours");
            
      String sleepmode2=request.getParameter("txtG14Hours2");
        ...
        Integer inUseTotal=0;
        Integer inassumeTotal=0;
        
        if(sleepmode!=null & tquntty!=null & sleepmode2!=null)
        {
        	sleep1=Integer.parseInt(sleepmode);
        	sleep2=Integer.parseInt(sleepmode2);
        	sleepQnty=Integer.parseInt(tquntty);
        }
        
         if(assum !=null & assum2!=null & assumqnty!=null)
        {
        
         	assTotal=(sleep1*sleep2*sleepQnty*52)/1000;
         	rs1=assTotal*4;
      	}
        
        if(assume!=null & tquntty!=null & nohourperweek!=null)
        {
       	 u=Integer.parseInt(assume);
       	 j=Integer.parseInt(tquntty);
       	 k=Integer.parseInt(nohourperweek);
        }
        
        
        if(u !=null & j!=null & k!=null)
        {
  ...
  <div align="center">
    <table border="0" cellpadding="0" cellspacing="0">
      <tbody><tr>
        <td rowspan="10" width="10">&nbsp;</td>
		    <td width="130">&nbsp;</td>
		    <td><font size="-2">In Use</font></td>
		    <td><font size="-2">Sleep</font></td>
		    <td>&nbsp;</td>
        ...
        <tr>
          <td>kWh per Year&nbsp;&nbsp;</td>
		    <td><input name="txtG14kWh1" size="5" type="text" value="<%=h %>"/></td>
		    <td><input name="txtG14kWh2" size="5" type="text" value="<%=assTotal %>"/></td>
		    <%
		    inUseTotal=h+assTotal;
		    
		     %>
		    <td>&nbsp;</td>
		    <td><input name="txtG14kWh3" size="5" type="text" value="<%=inUseTotal %>"/></td>
		    <td><input name="txtG14kWh" size="5" type="hidden"/></td>
	    </tr>
        <tr>
          <td>Rs. per Year&nbsp;&nbsp;</td>
		    <td><input name="txtG14Dollars1" size="5" type="text" value="<%=rs %>"/></td>
		    <td><input name="txtG14Dollars2" size="5" type="text" value="<%=rs1 %>"/></td>
		    
		    <%
		    inassumeTotal=rs+rs1;
		    
		     %>
		    <td>&nbsp;</td>
		    <td><input name="txtG14Dollars3" size="5" type="text" value="<%=inassumeTotal %>"/></td>
		    <td><input name="txtG14Dollars" size="5" type="hidden"/></td>
	    </tr>
        </tbody>
    </table>
  </div>
