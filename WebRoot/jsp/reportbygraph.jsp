...
#chart6 .jqplot-meterGauge-tick, #chart6 .jqplot-meterGauge-label {
    font-size: 9pt;
    color: #484848;
}
#chart7 .jqplot-meterGauge-tick, #chart7 .jqplot-meterGauge-label {
    font-size: 9pt;
    color: #484848;
}
</style>
...
<%   
  ...
  //response.sendRedirect("registration.jsp");
    ...
    String qu1="SELECT  SUM(product_count),count(*),CURRENT_TIME() FROM energy_data where rf_node_id='2'  and DATE_FORMAT(date_time, '%Y-%m-%d') = '2011-05-10' ORDER BY id DESC LIMIT 1";
 	String temp="SELECT  SUM(product_count),count(*),CURRENT_TIME(),raw_mat FROM energy_data where rf_node_id='4'  and DATE_FORMAT(date_time, '%Y-%m-%d') = '2011-05-10' ORDER BY id DESC LIMIT 1";
    String No_Door_open="SELECT  power_status  FROM energy_data where rf_node_id='8'  and DATE_FORMAT(date_time, '%Y-%m-%d') = '2011-05-10'";
   ...
   plot5 = $.jqplot('chart5',[s1],{
       seriesDefaults: {
           renderer: $.jqplot.MeterGaugeRenderer,
           rendererOptions: {
               label: 'Cummulative Power Consumed for today(W)',
               labelPosition: 'bottom',
               intervalOuterRadius: 120,
               ticks: [0,200, 400, 600, 800, 1000, 1200, 1400, 1600, 1800, 2000, 2200, 2400],
               intervals:[400, 800, 1200, 1600, 2000,2400],
              intervalColors:['#66cc66','#66cc66','#e7e658','#e7e658','#81a9e8','#81a9e8']
           }
       }
   });
   var x=randomXToY(220,240);
  //alert(x);
   ...
   var product=x*<%=acctualCurrent%>;
  // alert(product);
     s1 = [product];
   plot4 = $.jqplot('chart7',[s1],{
       seriesDefaults: {
           renderer: $.jqplot.MeterGaugeRenderer,
           rendererOptions: {
               label: ' Power (W) ',
               ...
               intervalColors:['#66cc66', '#E7E658', '#cc6666','#66cc66', '#E7E658', '#cc6666']
           }
       }
   });      
});</script> 
...
<hr />
<div style="color: #aa0000;">Instantaneous Digital Meters  </div>
<div id="chart4" class="plot" style="width:272px;height:185px;background-color: black;float: left;"></div>
<div id="chart6" class="plot" style="width:272px;height:185px;background-color: black;float: left;"></div>
<div id="chart7" class="plot" style="width:272px;height:185px;background-color: black;margin-left: 550px;"></div>
...
<tbody><tr>
    ...
    <tbody><tr>
       ...
       <td id="" class="white2"><b>Model</b></td> -->
		...
		<td id="" class="white2"><b>Power Consumed (W)</b></td>
        <td id="" class="white2"><b>Total Time (HH:MM)</b></td>
        <td id="" class="white2"><b>Temperature (°C)</b></td>
        <td id="" class="white2"><b>Door Open Count</b></td>
    </tr>
  ...
  <!-- <td id="" classname="white" class="white">
   ...
   <td classname="white" class="white" id="">Tata Global Beverage(No Freezer)
  Stabilizer Info: Rated - 0.85 KVA
   ...
   <td classname="white" class="white" id=""><%=location%>
    ...
    <td classname="white" class="white" id=""><%=roundinwatts11%>
 </td>
 
 
 </td>
    <td classname="white" class="white" id=""><%=hr+":"+mm%>
 </td>
 </td>
    <td classname="white" class="white" id=""><%=""+store_tempetaure%>
 </td>
 </td>
    <td classname="white" class="white" id=""><%=count%>
 </td>
   </tr>
