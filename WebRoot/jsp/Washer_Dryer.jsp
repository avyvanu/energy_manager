...
function getChoices(form)
{
  ...
  form.txtG4Loads.value = values.join(' ');
}
</script>
...
<br>
	...
	<div class="hdr-area">Washer &amp; Dryer</div><br>
...
function clearfrm4()
{
   var frmVar = document.frm4;
   var bAlert = false;
   
   if (frmVar.sel1G4App.selectedIndex == 0 && frmVar.txtG4Percent.value != "N/A")
   {
      frmVar.txtG4Percent.value = "N/A";
      bAlert = true;
   }
   
   
   if (bAlert)
      alert("This field is not used with this type of Appliance.");
...
<form name="frm4" action="Washer_Dryer.jsp" method="post">
<div class="calcframe">
  <div align="center">
    <table border="0" cellpadding="0" cellspacing="0">
      <tbody><tr><td rowspan="10" width="10">&nbsp;</td><td colspan="2" height="5">&nbsp;</td></tr>
        <tr><td>Appliance</td>
            <td>
              <select name="sel1G1App" onchange="getChoices(this.form)">
                <option value="19">Clothes washer</option>
                <option value="129">Clothes dryer</option>
              </select>
            </td>
      </tr>
        <tr><td>Assumed Wattage </td><td><input name="txtG4Loads" value="19" type="text" id="txtG4Loads"/></td></tr>
        <tr><td>Loads Per Week </td><td><input name="txtG4Loads11" value="1" type="text"/></td></tr>
        
        <tr><td>&nbsp;</td></tr>
        
        
        <tr><td>&nbsp;</td><td><input name="G4Compute" value="Compute" type="submit" style="font-size: 14px;"/><br>
          <input name="check" value="clothes" type="hidden"/> 
          <input name="hid1" type="hidden"/></td></tr>
           ...
           <%
      String assume=request.getParameter("txtG4Loads");
     // String tquntty=request.getParameter("txtG1Qty");
      String nohourperweek=request.getParameter("txtG4Loads11");
       ...
       %>
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td>kWh per Year </td><td><input name="txtG4kWh" type="text" value="<%=h %>"/> </td></tr>
        <tr><td>Rs. per Year </td><td><input name="txtG4Dollars" type="text" value="<%=rs %>"/></td></tr>
