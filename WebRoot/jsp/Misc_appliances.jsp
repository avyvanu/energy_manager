...
function getChoices(form)
{
  ...
  values  = new Array();
  options = form.sel1G12App.options;
...
<br>
	...
	<div class="hdr-area">Misc. Appliances</div><br>

	<!-- progbar.asp removed -->

<!-- Group 13 -->
<form name="frm12" action="" method="post">
<div class="calcframe">
  <div align="center">
    <table border="0" cellpadding="0" cellspacing="0">
      <tbody><tr>
        ...
        <td>
          <select name="sel1G12App" onchange="getChoices(this.form)">
            <option value="40000">Outdoor gas grill</option>
            <option value="2500">Outdoor gas lights</option>
            <option value="50000">Gas patio heater</option>
            </select>
            
       </td>
      </tr>
        <tr>
          <td>Assumed BTU/hour </td>
       <td><input name="txtG12BTU" value="40000" type="text" id="txtG1Wattage"/></td>
      </tr>
        <tr>
          <td>Quantity (number of appliances of this type)</td>
       <td><input name="txtG12Quant" type="text"/></td>
      </tr>
        <tr>
          <td>Average hours per week </td>
       <td><input name="txtG12Hrs" type="text"/></td>
      </tr>
        <tr>
          <td>Weeks per year</td>
       <td><input name="txtG12Wks" type="text" value="52"/></td>
      </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td>&nbsp;</td><td>
          <input name="G12Compute" value="Compute" type="submit" style="font-size: 14px;"/><br>
            <input name="check" value="misc" type="hidden"/>
            
            
            <%
            
             String assume=request.getParameter("txtG12BTU");
     		 String tquntty=request.getParameter("txtG12Quant");
     		 String nohourperweek=request.getParameter("txtG12Hrs");
             String Weeksperyear=request.getParameter("txtG12Wks");
        ...
        if(assume!=null & tquntty!=null & nohourperweek!=null & Weeksperyear!=null)
        {
       	 u=Integer.parseInt(assume);
       	 j=Integer.parseInt(tquntty);
       	 k=Integer.parseInt(nohourperweek);
       	 kl=Integer.parseInt(Weeksperyear);
        }
        
        
        if(u !=null & j!=null & k!=null & kl!=null)
        {
        ...
        <tr><td>&nbsp;</td></tr>
        <tr>
          <td>Therms per Year</td>
        <td><input name="txtG12Therms" type="text" value="<%= h%>"/></td>
      </tr>
        <tr>
          <td>Rs. per Year</td>
        <td><input name="txtG12Dollars" type="text" value="<%= rs%>"/></td>
      </tr>
        </tbody>
    </table>
  </div>
