...
<span><span id="dtx-highlighting-item" dtx-highlight-backgroundcolor="lime">
	</span></span><div class="hdr-area"><span><span id="dtx-highlighting-item" dtx-highlight-backgroundcolor="blue"><h3>Energy Cost</span><span id="dtx-highlighting-item" dtx-highlight-backgroundcolor="magenta"></h3></span></span></div><br><span>
...
<h3 align="center"><b>Air Conditioner - Central Unit</b></h3>
<br>
<div align="center">
  <table border="0" cellpadding="0" cellspacing="0" width="550">
    <tbody><tr bgcolor="Lightgrey" valign="middle">
      <td colspan="2" bgcolor="Lightgrey"><b>Typical Energy Input</b></td>
	      <td width="10" bgcolor="Lightgrey">&nbsp;</td>
	      <td colspan="2" bgcolor="Lightgrey"><b>Approximate Cost for Normal Use</b></td>
		    </tr>
      <tr bgcolor="lightyellow">
        <td colspan="5" bgcolor="Lightgrey">Efficiency Rating (SEER)</td>
	    </tr>
      <tr bgcolor="Lightgrey">
        <td colspan="3" bgcolor="#DDE6D5">7.0</td>
	      <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
          <td bgcolor="#DDE6D5">34¢ per ton per hour</td>
	    </tr>
      <tr bgcolor="lightyellow">
        <td colspan="3" bgcolor="#DDE6D5">9.0</td>
	      <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
          <td bgcolor="#DDE6D5">26¢ per ton per hour</td>
	    </tr>
      <tr bgcolor="Lightgrey">
        <td colspan="3" bgcolor="#DDE6D5">10.0</td>
	      <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
          <td bgcolor="#DDE6D5">23¾¢ per ton per hour</td>
	    </tr>
      <tr bgcolor="lightyellow">
        <td colspan="3" bgcolor="#DDE6D5">11.0</td>
	      <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
          <td bgcolor="#DDE6D5">21¼¢ per ton per hour</td>
	    </tr>
      <tr bgcolor="Lightgrey">
        <td colspan="3" bgcolor="#DDE6D5">12.0</td>
	      <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
          <td bgcolor="#DDE6D5">19¼¢ per ton per hour</td>
	    </tr>
      <tr bgcolor="lightyellow">
        <td colspan="3" bgcolor="#DDE6D5">13.0</td>
	      <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
          <td bgcolor="#DDE6D5">18¢ per ton per hour</td>
	    </tr>
      <tr bgcolor="Lightgrey">
        <td colspan="3" bgcolor="#DDE6D5">14.0</td>
	      <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
          <td bgcolor="#DDE6D5">16¾¢ per ton per hour</td>
	    </tr>
      </tbody>
  </table>
</div>
<br>
<h3 align="center"><b>Air Conditioner - Room Unit</b></h3>
<br>
	<div align="center">
	  <table border="0" cellpadding="0" cellspacing="0" width="550">
		<tbody><tr bgcolor="Lightgrey">
		  <td><b>Capacity (Btu/hr)</b></td>
		  <td width="10">&nbsp;</td>
		  <td colspan="2" align="left"><b>Efficiency<br>Rating (EER)</b></td>
		  <td width="10">&nbsp;</td>
		  <td align="Center"><b>Cost</b></td>
		</tr>
		<tr bgcolor="Lightgrey">
		  <td bgcolor="#DDE6D5">6,000 &nbsp;&nbsp;(½ Ton)</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">7.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">857 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">16¾¢ per hour</td>
		</tr>
		<tr bgcolor="lightyellow">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">8.5&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">706 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">13¾¢ per hour</td>
		</tr>
		<tr bgcolor="Lightgrey">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">10.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">600 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">11¾¢ per hour</td>
		</tr>
		<tr bgcolor="lightyellow">
		  <td bgcolor="#DDE6D5">9,000 &nbsp; &nbsp; (¾ Ton)</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">7.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">1286 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">25¢ per hour</td>
		</tr>
		<tr bgcolor="Lightgrey">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">8.5&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">1059 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">20½¢ per hour</td>
		</tr>
		<tr bgcolor="lightyellow">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">10.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">900 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		...
		<tr bgcolor="Lightgrey">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">11.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">818 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		...
		<tr bgcolor="lightyellow">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">12.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">750 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">14½¢ per hour</td>
		</tr>
		<tr bgcolor="Lightgrey">
		  <td bgcolor="#DDE6D5">12,000&nbsp;&nbsp; (1 Ton)</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">7.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">1714 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">33¢ per hour</td>
		</tr>
		<tr bgcolor="lightyellow">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">8.5&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">1412 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		...
		<tr bgcolor="Lightgrey">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">10.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">1200 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">23¼¢ per hour</td>
		</tr>
		<tr bgcolor="lightyellow">
		  <td bgcolor="#DDE6D5">18,000&nbsp;&nbsp;(1½ Ton)</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">7.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">2571 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">50¢ per hour</td>
		</tr>
		<tr bgcolor="Lightgrey">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">8.5&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">2118 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">41¢ per hour</td>
		</tr>
		<tr bgcolor="lightyellow">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">10.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">1800 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">35¢ per hour</td>
		</tr>
		<tr bgcolor="Lightgrey">
		  <td bgcolor="#DDE6D5">24,000&nbsp;&nbsp;(2 Ton)</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">7.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">3429 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">67¢ per hour</td>
		</tr>
		<tr bgcolor="lightyellow">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">8.5&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">2824 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">55¢ per hour</td>
		</tr>
		<tr bgcolor="Lightgrey">
		  <td bgcolor="#DDE6D5">&nbsp;</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
		  <td bgcolor="#DDE6D5">10.0&nbsp;&nbsp;&nbsp;&nbsp;</td><td align="right" bgcolor="#DDE6D5">2400 Watts</td>
		  <td width="10" bgcolor="#DDE6D5">&nbsp;</td>
        <td align="right" bgcolor="#DDE6D5">47¢ per hour</td>
		</tr>
		</tbody>
		</table>
		<br>
