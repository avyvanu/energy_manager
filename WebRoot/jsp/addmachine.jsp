        ...
        <div id="main">
			...
			<div class="main_box">
				...
				<div id="content">
					...
					<div><table style="margin-left: 180px;">
   ...
   <% 
    ...
    e.printStackTrace();
     ...
     %>
			...
			This zone have no sensor, Please add atleast one sensor to make this a valid  zone .
			</div>
					...
					<div id="tabs-3" style="display: none;width:700px;">
...
<tr>
 ...
 class="add_buttons" /> -->
  ...
  <td align="right" colspan="2" class="form2"> 
  <input type="button" value="" style="display: none;" onclick="Popup.showModal('modal',null,null,{'screenColor':'#000000','screenOpacity':.6});return false;" id="addsensor_button" class="addsensor_buttons" />

 	&nbsp;&nbsp;&nbsp;
 
 	<input type="button" value="" onclick="Popup.showModal('modal2',null,null,{'screenColor':'#000000','screenOpacity':.6});return false;" id="lnkForgot" class="add_buttons" />
 
 <!-- &nbsp;&nbsp;&nbsp;<input type="button" value="" class="del_buttons" onclick="getCheckedRadios_in_addmachine();return false;"  /> -->
</td><td></td>
  </tr>
</table>
