...
<br>
	...
	<div class="hdr-area">General Appliances</div><br>

	<!-- progbar.asp removed -->
 <div align="center">
<form name="frm1" action="GeneralAppliance.jsp" method="post">
<div class="calcframe"><table border="0" cellpadding="0" cellspacing="0">
  <tbody><tr>
...
<option value="35" >CD, DVD, VCR  player</option>
<option value="4">Clock radio</option>
<option value="40">Curling iron</option>
<option value="150">Electric blanket</option>
<option value="15">Electric shaver</option>
<option value="1200">Hair dryer</option>
<option value="60">Heating pad</option>
<option value="1000">Iron</option>
<option value="1000">Lawnmower</option>
<option value="100">Stereo with tape and/or cd player</option>
<option value="100">TV - small color</option>
<option value="200">TV - large color</option>
<option value="700">Vacuum cleaner</option>
<option value="350">Water bed</option>
</select>
    </td>
  </tr>
  <tr><td>Assumed Wattage</td><td><input name="txtG1Wattage" type="text" id="txtG1Wattage" value="35"/></td></tr>
  
  <tr><td>Quantity </td><td><input name="txtG1Qty" value="1" type="text"/><br></td></tr>
  
  <tr><td>Average hours per week </td><td><input name="txtG1Hours" value="1" type="text"/><br></td>  </tr>
  
 <tr><td>&nbsp;</td></tr>
 
  <tr><td>&nbsp;</td><td><input name="G1Compute" value="Compute" type="submit" style="font-size: 14px;"/><br>
  
      <input name="check" value="genapp" type="hidden"/>
      ...
      String nohourperweek=request.getParameter("txtG1Hours");
        ...
        if(u !=null & j!=null & k!=null)
        {
         	...
         	h=(u*j*k*52)/1000;
         	System.out.println("kwh per year----"+h);
         	rs=h*4;
         	System.out.println("rs per year----"+rs);
      	}
      
      
       %>
 <tr><td>&nbsp;</td></tr>
  <tr>  <td>kWh per Year </td> <td><input name="txtG1kWh" type="text" value="<%=h %>"/></td> </tr>
  <tr><td>Rs. per Year </td> <td><input name="txtG1Dollars" type="text" value="<%=rs %>"/></td>
