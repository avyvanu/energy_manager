...
arrowpointers:{
	downarrow: ["menu/arrow-down.gif", 7,3], //[path_to_down_arrow, arrowwidth, arrowheight]
	rightarrow: ["menu/arrow-right.gif", 3,5], //[path_to_right_arrow, arrowwidth, arrowheight]
