...
<div class="hdr-area">Refrig. &amp; Freezers</div><br>

	<!-- progbar.asp removed -->

<form name="frm2" action="Freezers.jsp" method="post">
<div class="calcframe">
  <div align="center">
    <table border="0" cellpadding="0" cellspacing="0">
      <tbody><tr>
        ...
        <tr>
          <td>Size </td>
        <td>
          <select name="sel1G2Size" onchange="G2ChangeValue()">
            <option value="420">Small refrigerator/freezer (14 - 20 cu. ft.)</option>
            <option value="660">Large refrigerator/freezer (22 cu. ft. or greater)</option>
            <option value="760">Small stand-alone freezer - chest</option>
            <option value="400">Small stand-alone freezer - upright</option>
            <option value="540">Large stand-alone freezer - chest </option>
            <option value="780">Large stand-alone freezer - upright</option>
            </select>          
       </td>
      </tr>
        <tr>
          <td>Age</td>
        <td>
          <select name="sel2G2Age">
            <option value="1">Less than 10 years old</option>
            <option value="2">10 years old or older</option>
            </select>          </td>
      </tr>
        <tr><td>&nbsp;</td></tr>
        <tr><td>&nbsp;</td><td><input name="G2Compute" value="Compute" type="submit" style="font-size: 14px;"/>
          <input name="check" value="refri" type="hidden"/>
          <input name="hid1" type="hidden"/>
          <input name="hid2" type="hidden"/><br></td></tr>
          
          
           <%
      String assume=request.getParameter("sel1G2Size");
      String tquntty=request.getParameter("sel2G2Age");
     // String nohourperweek=request.getParameter("txtG1Hours");
       ...
       %>
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td>kWh per Year </td><td><input name="txtG2kWh" type="text" value="<%=h %>"/></td></tr>
        <tr><td>Rs. per Year </td><td><input name="txtG2Dollars" type="text" value="<%=rs%>"/></td></tr>
        </tbody>
    </table>
  </div>
</div>
...
<div id="modal" style=" background-color:none; padding:25px; font-size:150%; display:none;">
	 <table style="border:3px solid black;" width="31%" cellspacing="0" cellpadding="0" >
        <tbody ><tr>
          <td class="header"><div style="float: left;width:96%;"> ADD SENSOR INFORMATION  </div><div> <a id="TB_closeWindowButton" style="color: #ffffff;text-decoration: none;" href="#" onClick="Popup.hide('modal')">X</a></div><br /></td> 
        </tr>

        <tr>
          <td class="home_box">=<!--  <iframe src="add_sensor_profile.jsp" id="myframe" width="430px" height="140px"></iframe>  -->            
          <br /></td>
        </tr>
      </tbody></table>
</div>
