...
<%
String appliance123= request.getParameter("createprofile");
System.out.println("a+++++++++++++++++++++++++"+appliance123);
...
<p>&nbsp;</p>
			...
			<div id="middle"> 
				...
				String createEnergyQuery1="select * from home_energy_manage where ApplianceName='"+appliance123+"'";
				System.out.println("=================="+createEnergyQuery1);
   					 try
				{
				 con=(Connection) ConnectDatabase.getConnection();
				// con=(Connection) ConnectDatabase.getConnection();
				 ps=con.prepareStatement(createEnergyQuery1);
				 rs=ps.executeQuery();
				
				 if(rs.next())
				 {
				 	applianceName=rs.getString(2);	
				 	watts=rs.getString(3);
				 	
				 	
				 }
				 // if(watts!=null && applianceName!=null)
				// {
				// request.setAttribute("watts",watts);
				// request.setAttribute("applianceName",applianceName);
				 //RequestDispatcher rd=request.getRequestDispatcher("ApplianceDropDown.jsp");
   			...
   			/*	if(appliance123.equals("all"))
   				{
   				
   				String createEnergyAll="select * from home_energy_manage";
				System.out.println("=================="+createEnergyAll);
				...
				// con=(Connection) ConnectDatabase.getConnection();
				 ...
				 String arrlen=String.valueOf(arrlength);	
	...
	<fieldset>
		...
		<table style="width: 80%;">
			...
			<tr>
					...
					<td><h3>Appliance Name :   <%=applianceName %></h3></td>
                    				<td><h3>Watts:<%=watts %></h3></td>
                    	    
									<td><a href=""><img src="" onclick="history.go(-1);return false;" title="Back" alt="Back" /></a></td>
			</tr>
		</table>
