        ...
        <div id="main">
			...
			<div class="main_box">
				...
				<div id="content">
					...
					<li id="contact" class="active2"><a href="view_machine_list.jsp">View Zone</a></li>
					<li id="contact" class="active"><a href="addsensor.jsp" onclick="Popup.showModal('modal',null,null,{'screenColor':'#000000','screenOpacity':.6});return false;">Add Appliance</a></li>
