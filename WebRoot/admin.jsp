...
<div id="chooser">
    ...
    %>
					...
					<li id="contact" class="active"><a href="addsensor_type.jsp">Add Sensortype</a></li>
...
<!--  <div>
<ul  id="">
						<li class="" id=""><a href="repository.jsp">Repository</a></li>
						<li class="" id=""><a href="admin.jsp">Admin</a></li>
						</ul>
