...
<div id="chooser">
		...
		<form method="post" name="myform" onsubmit="return getRow();" action="addmachine_value.jsp">
        <div id="main">
			...
			<div class="main_box">
				...
				<div id="content">
					...
					<div style="text-align:center;width:640px"><h1>ADD ZONE</h1></div>
    ...
    %>
					...
					<li class="active2" id="home"><a href="addmachine.jsp">Add Zone</a></li>
   ...
   <% 
    ...
    e.printStackTrace();
     ...
     %>
					...
					<div id="error_of_sensor" style="text-align:center;color:red;display: none;">
			This machine have no sensor, Please add atleast one sensor to make this a valid  machine .
			</div>
...
<tr>
    <td class="gridtd"><div style="max-height: 250px;overflow: auto">
      <table id="table2" width="100%" border="0" cellspacing="1" cellpadding="4">
    <tr>
...
<tr>
 ...
 class="add_buttons" /> -->
  <td align="right" colspan="2" class="form2"> <input type="button" value="" style="display: none;" onclick="Popup.showModal('modal',null,null,{'screenColor':'#000000','screenOpacity':.6});return false;" id="addsensor_button"
 class="addsensor_buttons" />&nbsp;&nbsp;&nbsp;<input type="button" value="" onclick="Popup.showModal('modal2',null,null,{'screenColor':'#000000','screenOpacity':.6});return false;" id="lnkForgot"
 class="add_buttons" /><!-- &nbsp;&nbsp;&nbsp;<input type="button" value="" class="del_buttons" onclick="getCheckedRadios_in_addmachine();return false;"  /> -->
</td><td></td>
  </tr>
</table>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0" style="display:none;" id="sensor_table">
<tr>
