...
function exit ()
{
	 var row_no = 1;
		...
		var rx=400;
            ...
            var textbox3 = textbox3 + '<input type="hidden" name="model" id="model" value="'+textbox3+'">';
            ...
            var textbox5 = textbox5 + '<input type="hidden" name="specification" id="specification" value="'+textbox5+'">';
