...
{
document.getElementById("error").innerHTML = "Location Name cannot be empty";
...
<%
    ...
    %>
         ...
         <form  name="" onSubmit="validate();" action="edit_location_pro.jsp">
...
<tr>
  ...
  int b = 1;
   ...
   String query="select * from machine_location_master where location_id='"+request.getParameter( "location_id" )+"' ";
   ...
   %> 
    <tr>
         <td>Location<span><font color="red">*</font></span></td>
        <td > 
...
<table width='100%'>
 ...
 class="save_buttons" />&nbsp;&nbsp;&nbsp;<input type="button" value="" onclick="parent.Popup.hide('modal3');" class="close_buttons" />
</td>
  </tr></table>
