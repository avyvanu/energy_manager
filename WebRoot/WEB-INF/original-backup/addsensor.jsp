        ...
        <div id="main">
			...
			<div class="main_box">
				...
				<div id="content">
					...
					<li id="contact" class="active2"><a href="addsensor.jsp">Add Sensor</a></li>
...
<tr>
  ...
  //  String phone=request.getParameter("phone");
    ...
    String quString1="select * from machine_master";
   ...
   <td id="" class="white" classname="white"><%out.print(machine_location);%>
