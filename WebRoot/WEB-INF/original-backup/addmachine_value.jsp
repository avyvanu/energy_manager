...
<html>
  ...
  String quString="insert into machine_master (machine_name, machine_location, machine_model, machine_description, machine_specification, machine_min_output, machine_max_output) VALUES ('"+list[i]+"','"+roomtype+"','"+list[i+1]+"','"+list[i+2]+"','"+list[i+3]+"','"+list[i+4]+"','"+list[i+5]+"')  ";
